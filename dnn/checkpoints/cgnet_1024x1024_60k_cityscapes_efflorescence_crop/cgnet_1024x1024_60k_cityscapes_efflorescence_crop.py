...
data_root = '/home/user/UOS-SSaS Dropbox/05. Data/02. Training&Test/102. Autolabel-train/02. efflorescence/crop'
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        ...
        data_root=
        '/home/user/UOS-SSaS Dropbox/05. Data/02. Training&Test/102. Autolabel-train/02. efflorescence/crop',
...
work_dir = './work_dirs/cgnet_1024x1024_60k_cityscapes_efflorescence_crop'
gpu_ids = range(0, 4)
auto_resume = False

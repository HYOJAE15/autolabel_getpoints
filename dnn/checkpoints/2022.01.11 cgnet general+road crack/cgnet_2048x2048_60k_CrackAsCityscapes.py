...
dataset_type = 'ConcreteCrackCityScapes'
data_root = '/home/user/UOS-SSaS Dropbox/05. Data/02. Training&Test/genral+road_crack'
img_norm_cfg = dict(
...
data = dict(
    ...
    workers_per_gpu=2,
    train=dict(
        type='ConcreteCrackCityScapes',
        data_root=
        '/home/user/UOS-SSaS Dropbox/05. Data/02. Training&Test/genral+road_crack',
...
work_dir = '/home/user/UOS-SSaS Dropbox/05. Data/03. Checkpoints/2022.01.11 cgnet general+road crack'
gpu_ids = range(0, 4)
